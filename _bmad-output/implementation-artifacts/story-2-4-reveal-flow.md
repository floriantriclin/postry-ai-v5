...
- **Migration DB** : Une mise à jour du schéma est nécessaire pour supporter la pré-persistance (voir [`../planning-artifacts/architecture/migrations/20260123-update-posts-schema.md`](../planning-artifacts/architecture/migrations/20260123-update-posts-schema.md)).
...
- **[DONE]** Analyse des exigences et des dépendances.
    - **Dépendance DB**: La table `posts` doit être migrée pour inclure `email` (TEXT), `status` (TEXT, default 'pending') et rendre `user_id` (UUID) nullable. La migration [`20260123-update-posts-schema.md`](../planning-artifacts/architecture/migrations/20260123-update-posts-schema.md) est confirmée comme étant correcte.
...
- [x] **Tâche 2.4.1 :** Exécuter la migration [`20260123-update-posts-schema.md`](../planning-artifacts/architecture/migrations/20260123-update-posts-schema.md).
