...
export default function Home() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center p-6 md:p-24 bg-white overflow-x-hidden">
      ...
      <footer className="absolute bottom-0 left-0 w-full p-6 flex justify-center space-x-4 opacity-30 font-mono text-xs uppercase tracking-widest pointer-events-none bg-white">
        <span>v5.0-BRUT</span>
        <span>•</span>
