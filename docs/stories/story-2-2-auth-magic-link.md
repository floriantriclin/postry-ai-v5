...
- `public.users` : Créé via le trigger `on_auth_user_created` (voir `docs/architecture/08-schema-de-base-de-donnees.md#script-dinitialisation-sql`). Aucune insertion manuelle requise.
